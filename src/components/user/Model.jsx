...
export default {
  save(_this) {
    // funções recebem o this que irá representar o UserCrud atual em _this
  ...
  clear(_this) {
    //botão cancelar (limpa o estado atual)
    _this.setState({ user: initialState.user });
  },
  ...
  getUpdatedList(_this, user, add = true) {
